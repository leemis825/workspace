 ...
 *    ex) char fruit[6] ="apple";은 'a'가 저장된 메모리 주소값으로 바뀜
 ...
 *       - String(문자열), Tuple, ...
 *    → C언어는 절차지향언어이기 때문에 위의  Types를 사용하지는 않지만, C언어의 문자열은 
 *    Immutable Types와 비슷하다고 생각하면 쉬움
 * 
 */
...
int main(){
    printf("apple이 저장 된 시작주소 값: %u\n","apple");
    printf("두번째 문자 주소값: %u\n","apple"+1);
    printf("첫번째 문자: %c\n",*("apple"));
    printf("두번째 문자: %c\n",*("apple"+1));
    printf("배열로 표현한 세 번째문자: %c\n","apple"[2]);
